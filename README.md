About aws-cdk.cloud-assembly-schema-feedstock
=============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aws-cdk.cloud-assembly-schema-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-cdk.cloud-assembly-schema-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add aws-cdk.cloud-assembly-schema
# for installing globally
pixi global install aws-cdk.cloud-assembly-schema
```
...
It is possible to list all of the versions of `aws-cdk.cloud-assembly-schema` available on your platform:
...
```
pixi search aws-cdk.cloud-assembly-schema --channel conda-forge
```
